...
model_type = 'vit_h'
output_path = '../../sam_models/sam_onnx_vit_h_preprocess.onnx'
#output_q_path = '../../sam_models/sam_onnx_vit_h_preprocess_quantized.onnx'
...
torch.onnx.export(model_trace, input_image_torch, output_path, input_names=['input'], output_names=output_names)

#if quantize:
#    quantize_dynamic(
#        model_input=output_path,
#        model_output=output_q_path,
#        per_channel=False,
#        reduce_range=False,
