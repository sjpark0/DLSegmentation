...
model_type = 'sam2.1_hiera_large' #@param ["sam2_hiera_tiny", "sam2_hiera_small", "sam2_hiera_large", "sam2_hiera_base_plus"]
...
sam2_checkpoint = f"../../models/{model_type}.pt"
...
torch.onnx.export(sam2_encoder,
                  img,
                  f"../../sam2_models/{model_type}_encoder.onnx",
                  export_params=True,
                  opset_version=17,
